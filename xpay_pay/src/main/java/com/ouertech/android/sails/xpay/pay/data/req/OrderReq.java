 ...
 * ========================================================
 */
package com.ouertech.android.sails.xpay.pay.data.req;
...
public class OrderReq extends BaseRequest {
    ...
    private String genProductArgs() {
        ...
        try {
            ...
            packageParams.add(new BasicNameValuePair("appid", WEIXIN.APP_ID));
            packageParams.add(new BasicNameValuePair("body", "weixin"));
            packageParams.add(new BasicNameValuePair("mch_id", WEIXIN.MCH_ID));
