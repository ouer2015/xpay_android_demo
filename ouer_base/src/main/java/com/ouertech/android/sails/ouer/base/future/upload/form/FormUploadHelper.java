...
public class FormUploadHelper {
	 ...
	 * @return
	 */
	public static HttpURLConnection openConnection(FormUploadFuture future) throws Exception{
	 ...
	 * @throws Exception
	 */
	private static HttpURLConnection createPost(FormUploadFuture future) throws Exception{
