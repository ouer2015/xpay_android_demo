...
import com.ouertech.android.sails.xpay.lib.XPay;
...
public class PayActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		UtilLog.d("=================="+msgApi.getWXAppSupportAPI());
...
//						.show(PayActivity.this); // activity where it is displayed


				XPay.getInstance(PayActivity.this).checkUpgrade(1000, "ANDROID", "CHANNEL", null);
			}
		});
